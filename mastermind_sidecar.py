"""
Mastermind Sidecar — spacex-autonomy
...
class MastermindSidecar:
    ...
    def __init__(self, repo_name: str = "spacex-autonomy"):
        self.repo_name = repo_name
        self.start_time = time.time()
        self.health_cache: Dict[str, Any] = {}
        self._modules = [state_estimator, flight_controller, multi_vehicle_consensus]
